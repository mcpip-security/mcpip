...
# (docs/EXTENSIBILITY.md §8), so no gate can be APPROVED until an engine is registered
...
# ---------------------------------------------------------------------------
#
# Phase 2 of the author-your-own extensibility feature (docs/EXTENSIBILITY.md §8): a
...
# the fail-closed authorizer; see docs/EXTENSIBILITY.md §8). So this module ships ONLY the

...
[`ARCHITECTURE.md`](ARCHITECTURE.md)). The whole ceremony → mint → verify → tamper cycle is
...
sender-constraint model in [`ARCHITECTURE.md`](ARCHITECTURE.md).*
...
MCPIP already **verifies** SPIFFE ([`ARCHITECTURE.md`](ARCHITECTURE.md) describes the agent
...
The invariant "every Redis key stays tenant-prefixed" (see [`ARCHITECTURE.md`](ARCHITECTURE.md))

#!/usr/bin/env bash
# MCPIP — one-shot local demo quickstart (macOS / Linux).
#
...
# then runs the live company walkthrough (scripts/demo_company.py). Idempotent:
...
say "running the live company demo (mcpip-inc)"
python scripts/demo_company.py --base "http://localhost:${GATEWAY_PORT}"

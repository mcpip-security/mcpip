...
(``docs/integrate/EXTENSIBILITY.md §8``) — so a gate can be submitted + schema-validated + stored
...
class GateManifest(BaseModel):
    ...
    (``docs/integrate/EXTENSIBILITY.md §8``). So a gate manifest can be submitted + schema-validated +
